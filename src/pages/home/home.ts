    ...
    requirement_GPS() :Promise<any>
    {
      return new Promise((resolve, reject) => {
        ...
        .then((canRequest: boolean) => {
          if(canRequest) {
            this._locationAccuracy.isRequesting().then((reqing)=>{
              console.log(reqing)
                this._locationAccuracy.request(this._locationAccuracy.REQUEST_PRIORITY_LOW_POWER)
            ...
            alert('Yeu cau GPS that bai vui long thu lai');
          }
